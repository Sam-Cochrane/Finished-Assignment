...
using UnityEngine;
public class WaterWaveAbility : BaseAttack
{
    ...
    public void Attack(Vector3 pos)
    {
        ...
        switch (level)
        {
            case 1:
                ...
                Instantiate(pro, pos, Quaternion.Euler(pro.transform.eulerAngles.x, GenerateAttackAngle(), pro.transform.eulerAngles.z));
            ...
            case 3:
                ...
                pro.transform.localScale.Set(2.0f, 1.0f, 2.0f);
